    ...
    return (
        <div>
            ...
            <form name="scoreform" onsubmit="return false;">
                ...
                <button onClick={() => {
                    navigate(`/score/insert/${updateStudentId}/${updateChinese}/${updateMath}/${updateEnglish}`)
            ...
            <form >
                ...
                <button onClick={() => {
                    navigate(`/score/update/${updateId}/${studentId}/${chinese}/${math}/${english}`)
                }} disabled={!updateId || !studentId || !chinese || !math || !english}>提交</button>
                <input type="reset" value="重置" />
            </form>
